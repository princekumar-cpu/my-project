...
class Registration:
    ...
    def Take_Picture(self):
        ...
        while True:
            ...
            if len(NAME) == 0 :
                self.entry2_label.config(text = "* Please Enter Your Name!!!!!!")
                cap.release()  
            ...
            if os.path.isfile(file_loc):                            #################### Checking file_loc exist or not #########################
                ...
                if len(mylist)>0:                                   ##################### Checking path folder have already an image or not #####
                    ...
                    if messagebox.askquestion("Comfirm","Are You Sure?") == 'yes':
                        with open('BCA_Project\Details.txt','w') as f:
                            detail =ID + "\n" + NAME + "\n" + DURATION
                            f.writelines(detail)
    ...
    def register_new_employee(self,window1 = window1):
        ...
        self.registration_window.iconbitmap("BCA_Project\icon.ico")
...
def help_index(window1, help_index_window):
    ...
    def send_mail():
        ...
        try:
           with open("BCA_Project\Details.txt","r") as f:
...
def home_page(window1 = window1):
    ...
    class Data_insert():
        def insert_details(self):
            ...
            if lst[5] == "":
                return 0
            with open('BCA_Project\Data.csv','a') as f1:
    ...
    def go_to_help_index():
        ...
        help_index_window.iconbitmap("BCA_Project\icon.ico")
    ...
    def go_to_about():
        ...
        about_window.iconbitmap("BCA_Project\icon.ico")
    ...
    def Delete_employee():
        ...
        if msg == "yes":
            ...
            if os.path.isfile("BCA_Project\Details.txt"):
                with open("BCA_Project\Details.txt","w") as f:
                    f.write("")
    ...
    class Reset_Working_hour():
        def __init__(self):
            ...
            self.reset_duration.iconbitmap("BCA_Project\icon.ico")
    ...
    window1.iconbitmap("BCA_Project\icon.ico")
